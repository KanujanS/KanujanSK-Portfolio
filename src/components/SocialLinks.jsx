...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/kanujan-subakaran-156339292/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@Kanujan_SK",
    icon: Instagram,
    url: "https://www.instagram.com/kanujan_sk?igsh=a2xoMWhjMHJrbm5v&utm_source=qr",
    color: "#E4405F",
